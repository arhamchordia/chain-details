...
func BigQueryRegisterVaultsCmd(parentCmd *cobra.Command) {
	...
	vaults.BondCmd.Flags().BoolVarP(&vaults.PendingQuery, "pending", "p", false, "Filter by pending bond actions (optional)")
	...
	vaults.UnbondCmd.Flags().BoolVarP(&vaults.ConfirmedQuery, "confirmed", "c", false, "Filter by confirmed unbond actions (optional)")
	vaults.UnbondCmd.Flags().BoolVarP(&vaults.PendingQuery, "pending", "p", false, "Filter by pending unbond actions (optional)")
